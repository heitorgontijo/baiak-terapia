local config = {
money = 800000000, -- Dinheiro que vai custar
...
doPlayerSendTextMessage(cid, MESSAGE_STATUS_DEFAULT, "Desculpe, você precisa de 700kk e você nao tem dinheiro suficiente.")
