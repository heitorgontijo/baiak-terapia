local config = {
money = 150000000, -- Dinheiro que vai custar
...
doPlayerSendTextMessage(cid, MESSAGE_STATUS_DEFAULT, "Desculpe, você precisa de 150kk e você nao tem dinheiro suficiente.")
